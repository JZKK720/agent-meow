...
from agent_meow.tools.builtins import hindsight as hindsight_mod
from agent_meow.tools.builtins.hindsight import (
    HindsightRecallTool,
...
def test_hindsight_tools_absent_from_registry_when_sdk_missing(
    ...
    import agent_meow.tools.builtins as builtins_mod
