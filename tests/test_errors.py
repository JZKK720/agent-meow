...
from agent_meow.errors import _CODE_TO_HTTP_STATUS, ErrorCode, AgentMeowError
...
def test_omnigent_error_with_harness_violation_code_returns_500() -> None:
    """End-to-end: AgentMeowError(code=HARNESS_PROTOCOL_VIOLATION).http_status == 500.
...
def test_all_error_codes_have_http_status_mapping(code: str, expected_status: int) -> None:
    ...
    AgentMeowError.http_status — not wrong, but it hides drift.
