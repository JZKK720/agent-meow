...
from agent_meow.llms.adapters.openai import (
    OpenAIAdapter,
    OpenAICompatibleAdapter,
    _parse_sse_line,
)
from agent_meow.llms.types import ResponseTextDeltaEvent
...
def test_to_responses_tools_flattens_chat_format() -> None:
    from agent_meow.llms.adapters.openai import _to_responses_tools
...
def test_parse_responses_output_message() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_output
    from agent_meow.llms.types import MessageOutput
...
def test_parse_responses_output_function_call() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_output
    from agent_meow.llms.types import FunctionCallOutput
...
def test_parse_responses_output_native_tool() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_output
    from agent_meow.llms.types import NativeToolOutput
...
def test_parse_responses_response_full() -> None:
    ...
    from agent_meow.llms.types import MessageOutput, Usage
...
def test_parse_responses_event_text_delta() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_event
    from agent_meow.llms.types import ResponseTextDeltaEvent
...
def test_parse_responses_event_reasoning_delta() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_event
    from agent_meow.llms.types import ResponseReasoningTextDeltaEvent
...
def test_parse_responses_event_reasoning_summary_delta() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_event
    from agent_meow.llms.types import ResponseReasoningSummaryTextDeltaEvent
...
def test_parse_responses_event_reasoning_started() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_event
    from agent_meow.llms.types import ResponseReasoningStartedEvent
...
def test_parse_responses_event_native_tool_done() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_event
    from agent_meow.llms.types import NativeToolOutputAddedEvent
...
def test_parse_responses_event_completed() -> None:
    from agent_meow.llms.adapters.openai import _parse_responses_event
    from agent_meow.llms.types import ResponseCompletedEvent
...
def test_streamed_400_overflow_classified_as_context_window_exceeded(
    ...
    from agent_meow.llms.errors import ContextWindowExceededError
    from agent_meow.runtime.llm_retry import classify_llm_error
