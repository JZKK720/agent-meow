...
def test_git_list_changed_files_raises_on_timeout(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("agent_meow.runtime.filesystem_registry.subprocess.run", _raise_timeout)
...
def test_git_list_changed_files_raises_on_nonzero_exit(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("agent_meow.runtime.filesystem_registry.subprocess.run", _nonzero)
...
def test_git_list_changed_files_honors_env_timeout(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("agent_meow.runtime.filesystem_registry.subprocess.run", _capture)
...
def test_untracked_cache_failure_does_not_break_init(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("agent_meow.runtime.filesystem_registry.subprocess.run", _raise_oserror)
...
def test_untracked_cache_config_written_once_per_root(tmp_path: Path, monkeypatch) -> None:
    ...
    """
    from agent_meow.runtime import filesystem_registry as fsr
...
def test_git_common_dir_resolves_linked_worktree(tmp_path: Path) -> None:
    ...
    from agent_meow.runtime.filesystem_registry import _git_common_dir
...
def test_git_line_counts_numstat_failure_degrades_but_status_intact(
    ...
    monkeypatch.setattr("agent_meow.runtime.filesystem_registry.subprocess.run", _fail_numstat)
