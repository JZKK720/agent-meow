...
from agent_meow.runtime.workflow import _route_bare_model_for_compaction
from agent_meow.spec.types import CompactionConfig, LLMConfig
...
def test_route_bare_model_prefixes_anthropic_claude() -> None:
    ...
    summarization LLM call 500'd. It must be nudged to ``anthropic/â€¦``.
    """
