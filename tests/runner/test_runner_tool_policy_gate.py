...
_BROKEN_PATH = "agent_meow.nonexistent_module.broken_policy"
...
_RAISING_PATH = "agent_meow.policies.function.make_fixed_action_callable"
...
async def test_resolve_diagnostic_omits_exception_message_secrets() -> None:
    ...
    import agent_meow.runner.policy as policy_mod
