...
@pytest.mark.parametrize(
    "line",
    [
        'patch("agent_meow.tools.mcp.asyncio.sleep")',
        'mock.patch("agent_meow.tools.mcp.asyncio.sleep", new_callable=AsyncMock)',
        'monkeypatch.setattr("agent_meow.llms.client.asyncio.sleep", _fake)',
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        'patch("agent_meow.tools.mcp._sleep", new_callable=AsyncMock)',
...
def test_main_exit_codes(tmp_path: Path) -> None:
    ...
    dirty.write_text('patch("agent_meow.x.asyncio.sleep")\n')
    clean = tmp_path / "test_clean.py"
    clean.write_text('patch("agent_meow.x._sleep")\n')
