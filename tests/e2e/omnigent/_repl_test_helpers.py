"""Shared helpers for the agent-meow REPL pexpect tests.
...
phase 0 merge â€” the foundation is shared with another agent's
...
# least once inside one chunk â€” keeps draining responsive
...
def drain_for(child: pexpect.spawn, total_timeout: float) -> str:
    ...
    burst across multiple frames â€” a single read can return
    ...
    :param total_timeout: Overall seconds to spend draining,
        ...
        render frames settle" is 2â€“6 seconds.
