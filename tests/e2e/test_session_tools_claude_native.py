...
to Claude Code when running in an agent-meow claude-native session.
...
_RUN_GATE_ENV = "AGENT_MEOW_E2E_CLAUDE_NATIVE_SESSION_TOOLS"
...
def test_claude_native_session_tools_visible(
    ...
    in Claude Code's MCP tool list when running in an agent-meow
