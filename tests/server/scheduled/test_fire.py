"""Tests for the scheduled-task fire path (:mod:`agent_meow.server.scheduled.fire`).
...
from agent_meow.db.db_models import current_workspace_id
from agent_meow.entities import ScheduledTask
from agent_meow.server.auth import LEVEL_OWNER, RESERVED_USER_LOCAL
from agent_meow.server.scheduled import fire as fire_mod
...
async def test_connected_host_dispatch_uses_resolved_local_owner(
    ...
    import agent_meow.server.routes._host_launch as host_launch
...
async def test_resolve_default_workspace_returns_canonical_path(
    ...
    import agent_meow.server.routes._workspace_validation as wsv
