...
@pytest.mark.parametrize(
    ...
    [
        ...
        # INTERNAL_ERROR (�?00) and a message carrying the raw status.
        (
            500,
            {},
            500,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # (�?00) and the route's default transfer-failure message.
        (
            500,
            {},
            500,
...
async def test_copy_files_rollback_deletes_blobs_when_row_delete_fails(
    ...
    caplog.set_level(logging.WARNING, logger="agent_meow.server.routes.sessions")
...
async def test_relay_persists_failed_status_error_labels_from_runner() -> None:
    ...
    assert (
        store._conversations["79b22ebd2309e48fdeb450c65611d51b"].labels[
            "agent_meow.last_task_error_code"
        ]
        == "required_terminal_exited"
    )
    assert (
        store._conversations["79b22ebd2309e48fdeb450c65611d51b"].labels[
            "agent_meow.last_task_error_message"
        ]
