...
async def test_session_snapshot_uses_child_spec_metadata(
    ...
    monkeypatch.setattr("agent_meow.runtime.get_runner_client", lambda: None)
...
async def test_persist_error_labels_truncates_long_message() -> None:
    ...
    stored = captured["0099dc8be6d82871e2e450424d46d1b7"]["agent_meow.last_task_error_message"]
...
async def test_persist_error_labels_short_message_stored_verbatim() -> None:
    ...
    assert (
        captured["d6e1678fb446a1cf5a892e0df60aaba3"]["agent_meow.last_task_error_message"]
        == "Process exited with code 1"
    )
    assert (
        captured["d6e1678fb446a1cf5a892e0df60aaba3"]["agent_meow.last_task_error_code"]
        == "runner_error"
    )
