...
from agent_meow.opencode_native import (
...
def test_update_startup_progress_handles_none_and_active() -> None:
    ...
    from agent_meow.opencode_native import _update_startup_progress
...
def test_record_launch_for_fresh_session_persists_current_cwd(
    ...
    """
    import agent_meow.opencode_native as on
    from agent_meow.opencode_native_state import read_launch_state
