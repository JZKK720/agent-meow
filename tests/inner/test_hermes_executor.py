...
class TestSetupHermesHome:
    ...
    def test_config_registers_omnigent_mcp_server(self, setup) -> None:
        ...
        assert omnigent_mcp["args"][:2] == ["-m", "agent_meow.claude_native_bridge"]
