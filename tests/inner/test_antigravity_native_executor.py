...
import agent_meow.inner.antigravity_native_executor as executor_mod
from agent_meow.antigravity_native_bridge import (
    AntigravityNativeBridgeState,
    write_bridge_state,
)
from agent_meow.inner.antigravity_native_executor import AntigravityNativeExecutor
from agent_meow.inner.executor import ExecutorError, ExecutorEvent, TurnComplete
...
def test_latest_requested_model_picks_latest_user_input() -> None:
    ...
    """
    from agent_meow.inner.antigravity_native_executor import _latest_requested_model
...
def test_recommended_model_picks_recommended_entry() -> None:
    ...
    """
    from agent_meow.inner.antigravity_native_executor import _recommended_model
...
def test_run_turn_valid_effort_is_accepted(
    ...
    :returns: None.
    """
    from agent_meow.inner.executor import ExecutorConfig
...
def test_content_to_text_handles_string_blocks_none_and_other(tmp_path: Path) -> None:
    ...
    crashing.
    """
    from agent_meow.inner.antigravity_native_executor import _content_to_text
