...
from agent_meow import opencode_http_transport as transport_mod
from agent_meow.inner.executor import ExecutorError, TurnComplete
from agent_meow.inner.opencode_native_executor import OpenCodeNativeExecutor
...
def test_harness_create_app_builds_fastapi() -> None:
    ...
    from agent_meow.inner.opencode_native_harness import create_app
...
def test_harness_executor_factory_builds_from_env(
    ...
    from agent_meow.inner.opencode_native_harness import _build_opencode_native_executor
    from agent_meow.opencode_native_bridge import OPENCODE_NATIVE_BRIDGE_DIR_ENV_VAR
