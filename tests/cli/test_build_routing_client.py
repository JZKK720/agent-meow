...
from agent_meow.cli import _build_external_routing_client, _build_local_llm_routing_client
from agent_meow.server.smart_routing import ExternalRoutingClient, LLMRoutingClient
...
def test_llm_builds_client() -> None:
    ...
    with (
        patch(
            "agent_meow.runtime.policies.builder._resolve_server_llm_connection",
            return_value={"base_url": "b", "api_key": "k"},
        ),
        patch(
            "agent_meow.runtime.policies.builder._build_policy_llm_client",
