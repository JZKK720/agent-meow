...
_PROVIDER_ENV_VARS = [
    ...
    "OPENAI_BASE_URL",
    "AGENT_MEOW_OPENAI_BASE_URL",
    "OPENROUTER_API_KEY",
    "AGENT_MEOW_OPENROUTER_API_KEY",
    "GEMINI_API_KEY",
    "AGENT_MEOW_GEMINI_API_KEY",
...
def test_env_key_detection_accepts_omnigent_prefixed_alias(
    ...
    monkeypatch.setenv("AGENT_MEOW_ANTHROPIC_API_KEY", "some-secret-value")
...
def test_vertex_claude_detected_with_all_env_vars(
    ...
    agent-meow recognises the credential and routes through the CLI's own
    Vertex auth (GCP ADC).
    """
