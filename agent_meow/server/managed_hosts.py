...
:mod:`agent_meow.server.routes.host_tunnel`) —the user's own
...
if TYPE_CHECKING:
    from agent_meow.onboarding.sandboxes import SandboxLauncher
...
MANAGED_REPO_LABEL_KEY = "agent_meow.sandbox.repo"
...
def _modal_launcher_factory(
    ...
    def _build() -> SandboxLauncher:
        ...
        from agent_meow.onboarding.sandboxes.modal import ModalSandboxLauncher
...
def parse_sandbox_config(raw: object) -> ManagedSandboxConfig | None:
    ...
    if provider == "modal":
        ...
        from agent_meow.onboarding.sandboxes.cwsandbox import managed_token_ttl_s
        ...
        from agent_meow.onboarding.sandboxes.e2b import managed_token_ttl_s
...
def _daytona_launcher_factory(
    ...
    def _build() -> SandboxLauncher:
        ...
        from agent_meow.onboarding.sandboxes.daytona import DaytonaSandboxLauncher
...
def _boxlite_launcher_factory(
    ...
    def _build() -> SandboxLauncher:
        ...
        from agent_meow.onboarding.sandboxes.boxlite import BoxliteSandboxLauncher
...
def _cwsandbox_launcher_factory(
    ...
    def _build() -> SandboxLauncher:
        from agent_meow.onboarding.sandboxes.cwsandbox import CWSandboxLauncher
...
def _e2b_launcher_factory(
    ...
    def _build() -> SandboxLauncher:
        ...
        from agent_meow.onboarding.sandboxes.e2b import E2BSandboxLauncher
...
def _islo_launcher_factory(
    *,
    ...
    def _build() -> SandboxLauncher:
        ...
        from agent_meow.onboarding.sandboxes.islo import IsloSandboxLauncher
...
def _openshell_launcher_factory(
    *,
    ...
    def _build() -> SandboxLauncher:
        ...
        from agent_meow.onboarding.sandboxes.openshell import OpenShellSandboxLauncher
...
# env-var overrides —see agent_meow.onboarding.sandboxes.kubernetes).
...
def _kubernetes_launcher_factory(
    *,
    ...
    def _build() -> SandboxLauncher:
        ...
        from agent_meow.onboarding.sandboxes.kubernetes import KubernetesSandboxLauncher
