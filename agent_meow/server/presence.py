...
:mod:`~?agent_meow.runtime.session_stream`, the registry is process-local
...
# subscriber registry in ``agent_meow.runtime.session_stream``.
...
def reset_for_tests() -> None:
    ...
    ``agent_meow.server._elicitation_registry.reset_for_tests`` —
