...
from agent_meow.server.admin_list import AdminList, promote_if_listed
from agent_meow.server.auth import _RESERVED_USERS, RESERVED_USER_LOCAL, UnifiedAuthProvider
...
def create_accounts_auth_router(
    ...
    :param admin_list: File-backed admin roster, consulted on each
        ...
        :mod:`~?agent_meow.server.admin_list`).
