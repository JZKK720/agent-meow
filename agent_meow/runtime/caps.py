...
if TYPE_CHECKING:
    ...
    from agent_meow.server.smart_routing import RoutingClient
    from agent_meow.spec.types import LLMConfig, PolicySpec
...
class RuntimeCaps:
    ...
    :param llm: Server-level LLM configuration for policy
        ...
        :class:`~?agent_meow.policies.types.PolicyLLMClient`
    ...
    :param policy_llm_connection_factory: Optional callable invoked
        ...
        :class:`~?agent_meow.policies.types.PolicyLLMClient`. When
