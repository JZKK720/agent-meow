...
from agent_meow.policies.types import PolicyLLMClient
...
_ASK_ON_ADD_POLICY_SPEC = FunctionPolicySpec(
    ...
    function=FunctionRef(
        path="agent_meow.policies.builtins.safety.ask_on_add_policy",
        arguments=None,
    ),
)
...
def invalidate_default_policy_specs_cache() -> None:
    ...
    workspace context via :func:`~agent_meow.db.db_models.current_workspace_id`.
    """
    from agent_meow.db.db_models import current_workspace_id
