...
:class:`~?agent_meow.server.schemas.ElicitationResult` and
...
async def _await_elicitation(
    *,
    ...
    in :func:`~?agent_meow.runtime.workflow._drive_policy_approval`.
    ...
    :class:`~?agent_meow.errors.ElicitationDeclinedError` so callers can
...
def build_elicitation_request_event(
    ...
    *,
    ...
    :param elicitation_id: Unique id correlating this request to the
        consumer's :class:`~?agent_meow.server.schemas.ElicitationResult`
...
def _is_explicit_decline(raw: str | None) -> bool:
    ...
    :class:`~?agent_meow.errors.ElicitationDeclinedError` instead of
