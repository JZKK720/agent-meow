...
Never import this module outside of agent_meow.runtime.
...
# ``agent_meow.runtime``. Conversation-scoped: one entry per
...
# ``agent_meow.runtime``), the runner routes
...
# in :mod:`~?agent_meow.server.routes.terminal_attach` produces the
