...
:func:`~?agent_meow.runtime.session_stream.publish` whenever a
...
def counts_for(conversation_ids: list[str]) -> dict[str, int]:
    ...
    :class:`~?agent_meow.server.schemas.SessionListItem` in one
...
def project_for_peek(event: dict[str, Any]) -> dict[str, Any]:
    ...
    :class:`~?agent_meow.tools.builtins.spawn.SysSessionGetHistoryTool`
