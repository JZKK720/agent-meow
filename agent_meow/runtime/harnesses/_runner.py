...
Invoked by :class:`~?agent_meow.runtime.harnesses.process_manager.HarnessProcessManager`
...
- ``--module <python_path>``: importable module that exports
  ...
  :data:`~?agent_meow.runtime.harnesses._HARNESS_MODULES` before
...
def _load_harness_app(harness: str, module_path: str, conversation_id: str) -> FastAPI:
    ...
    :param module_path: Fully-qualified Python module to import,
        e.g. ``"agent_meow.inner.claude_sdk_harness"``. Must
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    :param argv: Argument list (without the program name),
        ...
        "agent_meow.inner.claude_sdk_harness", "--socket",
        "/tmp/agent_meow/<id>/conv-abc.sock", "--conversation-id",
    ...
    parser = argparse.ArgumentParser(
        prog="python -m agent_meow.runtime.harnesses._runner",
        description=(
