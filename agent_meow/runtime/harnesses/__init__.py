...
serves to external clients (re-use ``agent_meow.server.schemas`` —
...
_HARNESS_MODULES: dict[str, str] = {
    ...
    "kimi-code": "agent_meow.inner.kimi_harness",
    ...
    # on PATH (or set by AGENT_MEOW_HERMES_PATH; legacy HARNESS_HERMES_PATH honored).
