...
from agent_meow.entities import Account, ResolvedAccess, SessionPermission
...
class PermissionStore(ABC):
    ...
    def set_admin(self, user_id: str, is_admin: bool) -> None:
        ...
        :mod:`~?agent_meow.server.admin_list`), which only ever passes
    ...
    def resolve_access(
        ...
        live in :mod:`~?agent_meow.server.permissions`
