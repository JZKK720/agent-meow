...
:class:`~?agent_meow.tools.local.LocalPythonTool` in a subprocess.
...
- :func:`load_local_callable_tools` — helper that
  :class:`~?agent_meow.tools.manager.ToolManager` calls alongside
  :func:`~?agent_meow.tools.local.load_local_python_tools` to
...
class LocalCallableTool(Tool):
    ...
    :attr:`~?agent_meow.spec.types.LocalToolInfo.path` and is
    ...
    def dotted_path(self) -> str:
        ...
        Used by :func:`~?agent_meow.runtime.workflow._dispatch_local_callable_tool_async`
...
def load_local_callable_tools(
    ...
    handled by :func:`~?agent_meow.tools.local.load_local_python_tools`.
