...
from agent_meow.tools._pep723 import parse_inline_metadata
from agent_meow.tools._srt import wrap_with_srt
...
class LocalPythonTool(Tool):
    ...
    # ``agent_meow.runtime.workflow._dispatch_local_python_tool_async``
    ...
    def _prepend_srt(
        ...
        *,
        ...
        shared :func:`~?agent_meow.tools._srt.wrap_with_srt` helper
