...
the engine (in :mod:`~?agent_meow.runtime.policies.engine`) does
the filter-gate-dispatch-compose orchestration (see
POLICIES.md §4).

The two concrete subclasses live next to this module:

- :class:`~?agent_meow.policies.function.FunctionPolicy`
- :class:`~?agent_meow.policies.prompt.PromptPolicy`
...
:mod:`~?agent_meow.runtime.policies`.
"""
...
from agent_meow.spec.types import PolicySpec
...
class Policy(ABC):
    ...
    def reset_turn(self) -> None:  # noqa: B027 — intentional no-op default (see docstring)
        ...
        turn. Mirrors :meth:`~?agent_meow.runtime.policies.engine.PolicyEngine.reset_turn`.
        ...
        as :meth:`~?agent_meow.runtime.policies.engine.PolicyEngine.reset_turn`.
        """
