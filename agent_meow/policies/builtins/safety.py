...
from agent_meow.policies.schema import PolicyCallable, PolicyEvent, PolicyResponse
...
# PostToolUse hook contract (see ``agent_meow.native_policy_hook``).
...
# (see ``agent_meow.inner.cursor_policy_hook``). Cursor uses ``Shell``
...
# extension hook (see ``agent_meow.inner.pi_executor._gate_native_tool``).
...
# (see ``agent_meow.inner.hermes_policy_hook``). Hermes uses its own naming
...
POLICY_REGISTRY: list[dict[str, Any]] = [
    ...
    {
        "handler": "agent_meow.policies.builtins.safety.block_skills",
        "kind": "factory",
    ...
    {
        "handler": "agent_meow.policies.builtins.safety.enforce_sandbox",
        "kind": "factory",
    ...
    {
        "handler": "agent_meow.policies.builtins.safety.deny_pii_in_llm_request",
        "kind": "factory",
