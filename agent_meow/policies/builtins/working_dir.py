...
YAML usage::
    ...
    policies:
      no_dir_switch:
        type: function
        function:
          path: agent_meow.policies.builtins.working_dir.block_working_dir_changes
          arguments:
...
from agent_meow.policies.builtins._shell import (
    MAX_SHELL_NESTING,
...
POLICY_REGISTRY: list[dict[str, Any]] = [  # type: ignore[explicit-any]
    {
        "handler": "agent_meow.policies.builtins.working_dir.block_working_dir_changes",
        "kind": "factory",
