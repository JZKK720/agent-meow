...
:mod:`~?agent_meow.policies.schema`): ``tool_call`` events carry
...
YAML usage::
    ...
    policies:
      gdrive_guard:
        type: function
        function:
          path: agent_meow.policies.builtins.google.gdrive_policy
          arguments: {read_all: false, read_files: ["1AbC..."], allow_create: true}
      gmail_guard:
        type: function
        function:
          path: agent_meow.policies.builtins.google.gmail_policy
...
from agent_meow.policies.schema import PolicyEvent, PolicyResponse, StateUpdateEntry
...
POLICY_REGISTRY: list[dict[str, Any]] = [  # type: ignore[explicit-any]
    {
        "handler": "agent_meow.policies.builtins.google.gdrive_policy",
        "kind": "factory",
    ...
    {
        "handler": "agent_meow.policies.builtins.google.gmail_policy",
        "kind": "factory",
        "name": "Gmail Access",
        "description": (
    ...
    {
        "handler": "agent_meow.policies.builtins.google.gcalendar_policy",
        "kind": "factory",
