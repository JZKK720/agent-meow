...
Usage::
    ...
    from agent_meow.policies.registry import load_registry, get_registry
    ...
    schema = get_params_schema("agent_meow.policies.builtins.safety.max_tool_calls_per_turn")
"""
...
class PolicyRegistryEntry:
    ...
    :param handler: Full dotted import path to the callable,
        e.g. ``"agent_meow.policies.builtins.safety.ask_on_os_tools"``.
...
def load_registry(
    ...
    """
    from agent_meow.policies.builtins import BUILTIN_POLICY_MODULES
...
def get_params_schema(handler: str) -> dict[str, Any] | None:
    ...
    :param handler: Full dotted import path, e.g.
        ``"agent_meow.policies.builtins.safety.max_tool_calls_per_turn"``.
