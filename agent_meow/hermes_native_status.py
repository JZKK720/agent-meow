...
:func:`~?agent_meow.hermes_native_forwarder.forward_hermes_store_to_session` poll
...
:mod:`~?agent_meow.cursor_native_status`. Persisting the posted-count means a
...
def clear_hermes_status_state(bridge_dir: Path) -> None:
    ...
    Sibling of :func:`~?agent_meow.hermes_native_forwarder.clear_hermes_bridge_state`:
