...
:func:`~?agent_meow.hermes_native_bridge.write_policy_hook_config`). Hermes' own
in-terminal approval prompt still fires for dangerous commands and is mirrored
to the web UI by :mod:`~?agent_meow.hermes_native_permissions`.
"""
...
from agent_meow.inner.hermes_native_executor import HermesNativeExecutor
