...
via :data:`~?agent_meow.runtime.harnesses._HARNESS_MODULES`.

The registry key is ``"openai-agents"`` (matching the agent-meow
...
around a :class:`~?agent_meow.inner.openai_agents_sdk_executor.OpenAIAgentsSDKExecutor`
...
- ``HARNESS_OPENAI_AGENTS_DATABRICKS_PROFILE``: Databricks-specific
  ...
  builder
  :func:`~?agent_meow.runtime.workflow._build_openai_agents_sdk_spawn_env`
