...
Wraps a :class:`~?agent_meow.inner.cursor_executor.CursorExecutor`, which
...
from agent_meow.inner.cursor_executor import CursorExecutor
...
def _resolve_os_env() -> OSEnvSpec:
    ...
    Decodes the JSON-encoded dict agent-meow serialized via
