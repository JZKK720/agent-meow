...
:class:`~?agent_meow.inner.executor.ToolSpec` becomes a ``cursor_sdk.CustomTool``
...
class CursorExecutor(Executor):
    ...
    async def _evaluate_native_tool_policy(
        ...
        <agent_meow.inner.claude_sdk_executor.ClaudeSDKExecutor>` exposes
    ...
    def _make_custom_tools(
        ...
        ``_tool_executor`` — the bridge into agent-meow's tool dispatch.
        """
