...
counterpart to :class:`~?agent_meow.inner.openai_agents_sdk_executor.OpenAIAgentsSDKExecutor`
and :class:`~?agent_meow.inner.claude_sdk_executor.ClaudeSDKExecutor`: a direct
...
:class:`~?agent_meow.inner.executor.ExecutorEvent` instances.
