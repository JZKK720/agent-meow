...
certificates signed by the CA from :mod:`~?agent_meow.inner.egress.ca`.
...
class EgressProxy:
    ...
    :param auth_token: When set, every inbound proxy connection MUST
        ...
        :func:`~?agent_meow.inner.os_env._HelperProcessClient.
    ...
    def _rewrite_authorization(
        ...
        - **Placeholder swap (opt-in).** When the request's
          ...
          :data:`~?agent_meow.inner.credential_proxy.SYNTHETIC_CREDENTIAL_PREFIX`
