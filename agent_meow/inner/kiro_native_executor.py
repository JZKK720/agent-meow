"""Executor that bridges agent-meow web-chat turns into the native Kiro TUI."""
...
from agent_meow.kiro_native_bridge import KIRO_NATIVE_BRIDGE_DIR_ENV_VAR, inject_user_message
