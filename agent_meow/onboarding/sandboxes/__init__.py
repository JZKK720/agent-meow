...
_LAUNCHERS: dict[str, str] = {
    "lakebox": "agent_meow.onboarding.sandboxes.lakebox:LakeboxLauncher",
    "modal": "agent_meow.onboarding.sandboxes.modal:ModalSandboxLauncher",
...
def get_launcher(provider: str, *, workspace_host: str | None = None) -> SandboxLauncher:
    ...
    :param workspace_host: Databricks workspace fronting the target
        ...
        :func:`~?agent_meow.onboarding.sandboxes.bootstrap.derive_workspace`),
    ...
    if provider == "lakebox" and workspace_host is not None:
        ...
        from agent_meow.onboarding.sandboxes.lakebox import LakeboxLauncher
