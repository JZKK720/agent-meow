...
:mod:`~?agent_meow.onboarding.cursor_auth`.
"""
...
def antigravity_sdk_installed() -> bool:
    ...
    :func:`~?agent_meow.onboarding.databricks_config.databricks_sdk_installed`: uses
...
def install_antigravity_sdk() -> bool:
    ...
    :func:`~?agent_meow.onboarding.harness_install.install_harness_cli`.
...
def antigravity_api_key_settings(ref: str) -> dict[str, object]:
    ...
    :returns: The settings dict for :func:`~?agent_meow.cli._save_global_config`.
    """
