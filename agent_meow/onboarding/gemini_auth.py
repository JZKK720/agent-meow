...
:func:`~?agent_meow.onboarding.ambient.codex_auth_has_credential` and
:func:`~?agent_meow.onboarding.ambient.claude_auth_has_credential`, it cannot detect
...
:func:`~?agent_meow.onboarding.harness_install.harness_cli_logged_in` asks the CLI
...
def gemini_auth_has_credential(creds_path: Path | None = None) -> bool:
    ...
    :func:`~?agent_meow.onboarding.harness_install.harness_cli_logged_in`.
