...
:func:`~?agent_meow.hermes_native_bridge._load_user_hermes_config`. A fresh install
...
from agent_meow.onboarding.harness_install import HERMES_KEY, harness_cli_installed
