...
:mod:`~?agent_meow.onboarding.provider_config` — that module imports *this*
one lazily inside :func:`~?agent_meow.onboarding.provider_config.resolve_secret`
...
def _keyring_disabled() -> bool:
    ...
    :func:`~?agent_meow.runtime.telemetry._env_bool`): ``"true"`` / ``"1"`` /
