...
from agent_meow._native_post_delivery import (
    append_dead_letter,
    ...
    *,
    ...
    with (
        ...
        telemetry.span(
            ...
            attributes={"agent_meow.response_id": item.response_id},
        ),
    ):
        resp = await client.post(
...
def _model_alias_for(model: str | None) -> str | None:
    ...
    :data:`agent_meow.claude_native._UCODE_CLAUDE_CUSTOM_TIER`) for the newer
