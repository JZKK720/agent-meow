...
class RunnerSubprocess:
    ...
    :param app_factory_path: Module-and-attribute path uvicorn will
        ...
        ``"agent_meow.runner.app:create_runner_app_from_env"``. Uvicorn's
    ...
    :param startup_timeout_s: Max wait for the subprocess to be
        ...
        factory cold-imports ``agent_meow.runner.app`` (and the whole
    ...
    app_factory_path: str = "agent_meow.runner.app:create_runner_app_from_env"
