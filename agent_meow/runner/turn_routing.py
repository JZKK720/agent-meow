...
The sibling of :mod:`agent_meow.runner.subagent_routing`, for the MAIN
...
* **Runner side** 鈥?a loopback HTTP relay (:func:`start_turn_router`) on
...
* **Server side** 鈥?the policy (:func:`resolve_turn_route`), which runs
...
**The authoritative gate is** :func:`already_routed` 鈥?the session's
...
already in flight 鈥?codex binds the turn's model before
``UserPromptSubmit`` runs (design plan 搂3b, spike S1), and claude's hook
...
prompt as a normal user turn 鈥?which then runs routed. The two harnesses
...
block marker stops any later hook from asking again 鈥?so a replay that
...
strictly larger than the hop it waits on 鈥?otherwise an inner hop's
fail-open branch can never run. Canonical values, outermost first:

1. harness hook timeout 鈥?:data:`HARNESS_HOOK_TIMEOUT_S` (15s, registered
   on each harness's ``UserPromptSubmit`` entry)
2. hook script HTTP request + model switch 鈥?   :data:`HOOK_REQUEST_TIMEOUT_S` (8s) then
   :data:`SETTINGS_UPDATE_TIMEOUT_S` (5s)
3. runner loopback relay wait 鈥?:data:`RELAY_TIMEOUT_S` (7s)
4. server relay hop 鈥?:data:`SERVER_HOP_TIMEOUT_S` (6s)

Inside hop 4 sits the routing call itself
(:data:`agent_meow.server.smart_routing.ROUTING_REQUEST_TIMEOUT_S`, 5s).
...
visible pause rather than a hang 鈥?and each hop still has room to run its
...
from agent_meow.runner.subagent_routing import routing_enabled, write_advertisement
...
#: conversation keyed on it 鈥?a ``/clear`` rotation re-keys the superseded
#: session and hands the SAME live dir to the new one, and a fork inherits its
#: parent's bridge id 鈥?so a bare file would make every later conversation in
...
#: will ever ask again 鈥?the blocked prompt is silently lost forever.
PENDING_FILE = "turn_replay_pending.json"

#: Bridge-dir file every hook invocation appends one line to, whatever it
#: decides. A hook that falls open before its POST is invisible otherwise 鈥?#: the harness discards its stdout and the runner never hears from it 鈥?so
...
#: Code's own 30s ``UserPromptSubmit`` default 鈥?the harness must not be the
#: layer that gives up first.
HARNESS_HOOK_TIMEOUT_S = 22

#: Hop 2a: the hook script's HTTP budget for the routing verdict. This is
#: the user-visible cost of a wedged router 鈥?the prompt sits in the pane
#: until it expires 鈥?but it must also outlast a HEALTHY route, which is
...
#: server-side route runs inside this 鈥?catalog preparation and then the
...
#: Coroutine that returns ``(model, verdict)`` for one turn 鈥?the
#: ``agent_meow.server.smart_routing.route_turn`` seam, injected so the
...
# 鈹€鈹€ Hook-side trace 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def trace_turn_routing(bridge_dir: Path, outcome: str, detail: str = "") -> None:
    ...
    did not route always says which gate it stopped at 鈥?the alternative is
    ...
    :param outcome: Short verdict tag 鈥?``"route"``, ``"allow"``,
        ``"skip"`` or ``"fail-open"``.
...
# 鈹€鈹€ Wire types 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
class TurnRouteDecision:
    ...
    :param action: ``"route"`` (block the prompt, switch to ``model``, and
        let the runner replay it) or ``"allow"`` (nothing routed 鈥?the
    ...
    def from_payload(cls, payload: Mapping[str, Any]) -> TurnRouteDecision:
        ...
        :returns: Parsed decision; an unknown action degrades to
            ``"allow"``, and a ``"route"`` with no model does too 鈥?the
...
# 鈹€鈹€ The block marker (session-scoped) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def write_turn_routing_marker(
    ...
    *,
    ...
    :returns: ``True`` when the marker is on disk. A marker that cannot be
        written must stop the hook from blocking 鈥?it is the runner's "you
...
def turn_routing_marker_present(bridge_dir: Path, session_id: str) -> bool:
    ...
    A marker naming a different session reads as ABSENT 鈥?that is the whole
...
# 鈹€鈹€ Policy (server side) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def already_routed(conv: Any) -> bool:
    ...
    ``turn/started``, which lands about a second into the turn 鈥?racing,
    ...
    ``model_override`` 鈥?either the pin sites labelling their writes, or
    ...
    """
    from agent_meow.runner.subagent_routing import ROUTING_DECISION_LABEL_KEY
...
def out_of_parent_family(
    ...
    family could serve 鈥?routing it here would pick a model the pane cannot
    ...
    """
    from agent_meow.runner.subagent_routing import (
...
def create_route_covers_prompt(conv: Any, prompt: str) -> bool:
    ...
    would score it again 鈥?a second router call, seconds later, for a verdict
    ...
    """
    from agent_meow.runner.subagent_routing import CREATE_ROUTE_PROMPT_LABEL_KEY
...
async def resolve_turn_route(
    ...
    *,
    ...
    hook call 鈥?including the one the replayed prompt fires 鈥?cannot route
    ...
    :param record_decline: Coroutine persisting a declined chip when a
        ...
        branches use it 鈥?the benign allows (already routed, routing off,
        family guard) are not failures and stay chipless. ``None`` skips it.
    :returns: The verdict the hook enforces.
    """
    from agent_meow.codex_model_vocabulary import comparable_model_id
    ...
    if not routing_enabled(
        ...
        # to be told the same thing. The cost of terminality is narrow 鈥?off
    ...
    if create_route_covers_prompt(conv, req.prompt) and (
        ...
        # a second judge call for the same answer 鈥?and block the prompt to
    ...
    except Exception as exc:  # noqa: BLE001 鈥?a router outage must never block a turn
        _logger.warning(
    ...
    # the model already running still blocked the prompt and replayed it 鈥?    # a needless block, a needless ``/model`` echo, and a turn the user
...
def decision_scope() -> str:
    ...
    :returns: ``"turn"`` 鈥?the same scope the composer turn gate uses, so
        the UI cannot tell the two triggers apart.
    """
    return _SCOPE


# 鈹€鈹€ Runner-side loopback relay 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def start_turn_router(
    *,
    ...
    :param bridge_dir: Session bridge directory 鈥?the same one the
...
def _handler_factory(
    ...
    class _Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self) -> None:
            ...
            except Exception:  # noqa: BLE001 鈥?never wedge a user's prompt
                _logger.warning(
    ...
    *,
    ...
    async def _resolve(session_id: str, req: TurnRouteRequest) -> TurnRouteDecision:
        ...
        try:
            ...
            payload = resp.json()
        except Exception:  # noqa: BLE001 鈥?server hop failures are expected
            _logger.warning(
...
# 鈹€鈹€ Pending-replay record 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
# 鈹€鈹€ The replay 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def schedule_replay(
    ...
    *,
    ...
    Ordering 鈥?the block must be in effect before the replay lands, and
    ...
    1. **Did the hook actually block?** The hook writes
       ...
       abandoned 鈥?a double-run is the one outcome worse than an unrouted
       turn.
    ...
    switch happens here (:func:`_apply_routed_model`) 鈥?after the block is
    in effect and before the prompt exists, so nothing races it.

    Finally the prompt goes through the **normal events path** 鈥?the same
    ``POST /v1/sessions/{id}/events`` the web composer uses 鈥?so it is
    ...
    :param blocked_turn_id: Harness turn id the blocked prompt was
        ...
        signal.
    :param server_client: Runner鈫抯erver client used to deliver the prompt.
...
async def _replay(
    ...
    *,
    ...
    if not await _wait_for(
        ...
        # The prompt ran on the old model, so nothing is owed 鈥?leaving the
...
async def _deliver_prompt(
    ...
    *,
    ...
    :param server_client: Runner鈫抯erver client.
...
# 鈹€鈹€ Crash recovery for a replay that never landed 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def schedule_pending_replay_recovery(
    ...
    *,
    ...
    Skipped unless the block marker is also present 鈥?a record without one
    means the hook fell open and the prompt already ran.

    :param session_id: Session/conversation identifier.
    :param bridge_dir: Session bridge directory.
    :param server_client: Runner鈫抯erver client. ``None`` skips recovery.
...
async def _prompt_already_ran(session_id: str, prompt: str, server_client: Any) -> bool | None:
    ...
    Compared STRUCTURALLY 鈥?the message blocks' own text fields, exactly 鈥?    never as a substring of the serialized page. Serializing escapes the text
    ...
    session. The same test read the other way round too 鈥?a short prompt
    ...
    try:
        ...
        resp.raise_for_status()
        payload = resp.json()
    except Exception:  # noqa: BLE001 鈥?an unreadable session is "unknown"
...
def _bridge_thread_probe(bridge_dir: Path) -> Callable[[], bool]:
    ...
    def _ready() -> bool:
        from agent_meow.codex_native_bridge import read_bridge_state
...
async def _apply_routed_model(
    ...
    *,
    ...
    would be typing. So the switch moves here 鈥?after the block is in
    ...
    if harness != "claude-native" or not model:
        return True
    from agent_meow.claude_model_vocabulary import claude_model_command_arg, normalized_model_id
...
def _settle_probe(bridge_dir: Path, harness: str | None) -> Callable[[str | None], bool]:
    ...
    replay must wait out. Claude blocks before any turn exists 鈥?nothing is
    persisted and no turn id reaches the hook 鈥?so the honest signal there
    ...
    if harness == "claude-native":
        ...
        def _pane_ready(blocked_turn_id: str | None) -> bool:
            del blocked_turn_id
            from agent_meow.claude_native_bridge import claude_pane_ready
...
async def _wait_for_cleared(
    ...
    seen as current, or after :data:`REPLAY_IDLE_GRACE_S` 鈥?otherwise the
...
# 鈹€鈹€ Per-session lifecycle (runner side) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def ensure_session_turn_router(
    ...
    *,
    ...
    :param session_id: Session/conversation identifier.
    :param bridge_dir: Directory the advertisement is written into 鈥?the
        same one the harness's hook command is pointed at.
    :param server_client: Runner鈫抯erver client. ``None`` skips the router
    ...
    :param routing_enabled: Whether the session launched with Smart Routing
        ...
        the absent advertisement as "do not register the route-turn hook" 鈥?        so a session that will never route pays no per-prompt round trip.
    ...
    try:
        ...
        return None
    # Nothing from the rendezvous is logged 鈥?neither the URL nor the paths
    # and ids that reach it 鈥?so a log file can never carry the bearer token
