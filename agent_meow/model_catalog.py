...
(:func:`~?agent_meow.model_override.normalize_model_for_provider`).
...
from agent_meow._platform import default_shell_argv
from agent_meow.model_override import model_family_mismatch
...
def model_family_token(model_id: str) -> str:
    ...
    :func:`~?agent_meow.model_override.model_family_mismatch`: Claude ids
...
def _resolve_model_provider_unsafe(spec: Any, harness: str | None) -> ResolvedModelProvider:  # type: ignore[explicit-any]  # structural spec stubs in tests
    ...
    from agent_meow.runtime.workflow import _resolve_provider_for_build
...
def _legacy_claude_sdk_provider(spec: Any) -> ResolvedModelProvider:  # type: ignore[explicit-any]  # structural spec stubs in tests
    ...
    :returns: A :class:`ResolvedModelProvider`.
    """
    from agent_meow.onboarding.configure_models import default_base_url_for_family
    from agent_meow.runtime.workflow import _load_global_auth
    from agent_meow.spec.types import ApiKeyAuth, DatabricksAuth
