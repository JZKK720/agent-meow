...
from agent_meow.kiro_native_bridge import write_forwarder_ready
...
def _discover_kiro_session_jsonl(
    *,
    ...
    """Find this agent-meow session's Kiro JSONL file — only when it's unambiguous.
    ...
    (:func:`~?agent_meow.cursor_native_forwarder._discover_store`).
