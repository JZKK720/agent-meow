...
def build(
    ...
    *factory_kwargs*, then decides whether the resolved callable
    ...
    :param configured_phases: The YAML ``on:`` list (verbatim
        ...
        :class:`~?agent_meow.inner.policies.FunctionPolicy`
        ...
        (:func:`~?agent_meow.spec.agent_meow._translate_function_policy_yaml`)
...
def _coerce_legacy_return(result: Any) -> Any:
    ...
    by :func:`~?agent_meow.policies.function._coerce_to_policy_result`.
...
def _legacy_context(
    ...
    *,
    ...
    :class:`~?agent_meow.inner.policies.FunctionPolicy.evaluate`,
