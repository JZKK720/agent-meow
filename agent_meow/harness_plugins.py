...
``agent_meow.community.harness`` entry point group.
"""
...
COMMUNITY_ENTRY_POINT_GROUP = "agent_meow.community.harness"
COMMUNITY_MODULE_PREFIX = "agent_meow.community.harness."
...
_BUILTIN_CONTRIBUTION = HarnessContribution(
    ...
    harness_modules={
        "acp": "agent_meow.inner.acp_harness",
