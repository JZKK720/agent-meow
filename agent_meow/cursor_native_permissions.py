...
``AskQuestion`` tool. To surface both in the agent-meow web UI (so a user can
...
from agent_meow.cursor_native_bridge import send_cursor_pane_keys
...
from agent_meow.cursor_native_forwarder import _discover_store, _read_blob_rows
...
def cursor_tool_call_elicitation_id(session_id: str, tool_call_id: str) -> str:
    """Return the deterministic agent-meow elicitation id for a gated tool call.
