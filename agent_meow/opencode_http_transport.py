...
:class:`~?agent_meow.native_server_harness.NativeServerHarness` drives it through
...
from agent_meow.opencode_native_bridge import read_bridge_state
...
def _attachment_to_part(attachment: Mapping[str, Any]) -> dict[str, Any] | None:
    """
    Convert an agent-meow attachment block into an OpenCode file part.
