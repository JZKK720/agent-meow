...
from agent_meow.opencode_native_bridge import update_active_message_id, update_last_event_id
from agent_meow.opencode_native_client import OpenCodeClient, OpenCodeEvent
...
class OpenCodeNativeForwarder:
    ...
    :param policy_evaluator: Optional async policy resolver. Production
        ...
        ``agent_meow.runner.app._build_opencode_policy_evaluator``) — the SAME
