...
(``agent_meow.runtime._globals.init``) and accessed via
``agent_meow.runtime.get_terminal_registry()`` from tools and the
workflow.
...
from agent_meow.inner.terminal import TerminalInstance, create_terminal_instance
...
class TerminalRegistry:
    ...
    def native_panes(self) -> list[tuple[str, str, Path]]:
        ...
        (:mod:`~?agent_meow.terminals.pane_reaper`); the reaper's wiring additionally
        ...
        """
        from agent_meow.terminals.pane_reaper import NATIVE_PANE_TERMINAL_NAMES
