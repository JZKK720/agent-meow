...
:mod:`~?agent_meow.inner.seatbelt_sandbox` calls
...
:mod:`~?agent_meow.sandbox.bwrap`).

Like ``linux_bwrap`` on Linux, the Seatbelt backend is the macOS
platform default (selected by :func:`~?agent_meow.inner.sandbox._default_sandbox_for_platform`
...
from agent_meow.inner.seatbelt_sandbox import SeatbeltSandboxBackend
