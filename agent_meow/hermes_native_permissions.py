...
terminal). Mirrors :mod:`~?agent_meow.cursor_native_permissions`. NB: Hermes only
...
from agent_meow.hermes_native_bridge import capture_hermes_pane, send_hermes_pane_keys
