...
Enter in the terminal). Mirrors :mod:`~?agent_meow.cursor_native_permissions`; the
...
from agent_meow.goose_native_bridge import capture_goose_pane, send_goose_pane_keys
