"""
Fast ``MessageDisplay`` hook for the native agent-meow Claude wrapper.
...
and :mod:`~?agent_meow.claude_native_forwarder`.
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(prog="python -m agent_meow.claude_native_message_display_hook")
