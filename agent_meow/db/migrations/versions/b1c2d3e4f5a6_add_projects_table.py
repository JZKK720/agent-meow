...
This migration creates only the container. Sessionâ†’project membership (the
...
from agent_meow.db.db_models import Uuid16
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Owner stamped on the row (projects have no ACL, Rule R032 / PRD Â§9).
