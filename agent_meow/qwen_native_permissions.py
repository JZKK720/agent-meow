...
:mod:`~?agent_meow.cursor_native_permissions`. See ``docs/QWEN_NATIVE_DESIGN.md`` and
...
from agent_meow.qwen_native_bridge import events_file_path, submit_confirmation
...
def _read_new_control_events(events_file: Path, offset: int) -> tuple[list[_ControlEvent], int]:
    ...
    Mirrors :func:`~?agent_meow.qwen_native_forwarder._read_new_events`: detects a
