...
from agent_meow.model_override import normalize_model_for_provider
...
if TYPE_CHECKING:
    ...
    from agent_meow.onboarding.ambient import CodexConfigTransport
...
def _databricks_pi_provider(entry: ProviderEntry, *, model: str | None) -> PiProviderConfig | None:
    ...
    from agent_meow.inner.codex_executor import _databricks_codex_auth_command
    from agent_meow.inner.databricks_executor import _read_databrickscfg_host
...
def _cli_config_databricks_transport(entry: ProviderEntry) -> CodexConfigTransport | None:
    ...
    :class:`~?agent_meow.onboarding.ambient.CodexConfigTransport` when so, else
    ...
    *,
    ...
    try:
        ...
        if resolved is None:
            ...
            from agent_meow.onboarding.provider_config import _parse_provider
