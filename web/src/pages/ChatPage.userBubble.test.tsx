...
describe("UserBubble @-mention attachment chips", () => {
  ...
  it("does not chip an absolute upload marker (already shown via its file block)", () => {
    renderBubble(
      userBubble(
        "[Attached: /var/folders/x/agent-meow-1/claude-native/abc/uploads/image.png]\n\nwhat is this",
      ),
    );
  ...
  it.each([
    ["C:\\Users\\me\\AppData\\Local\\Temp\\agent-meow\\uploads\\image.png", "drive (backslash)"],
    ["C:/Users/me/AppData/Local/Temp/agent_meow/uploads/image.png", "drive (forward slash)"],
    ["\\\\host\\share\\agent-meow\\uploads\\image.png", "UNC"],
  ...
  it("chips a relative @-mention but not an absolute upload in the same message", () => {
    renderBubble(
      userBubble(
        "[Attached: /tmp/agent_meow/claude-native/abc/uploads/image.png]\n" +
