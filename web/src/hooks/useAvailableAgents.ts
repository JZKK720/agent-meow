...
export interface AvailableAgent {
  ...
  // same-named `agent-meow run` upload, but lets a newer upload supersede a
 ...
 *   wins, so a fresh `agent-meow run agent.yaml` supersedes a stale template
