...
function DialogContent({
  ...
  // keyboard-aware visible height as `--agent-meow-viewport-height` on :root, so
  ...
  const iosViewportStyle: React.CSSProperties = isIOSShell()
    ? {
        ...
        top: "calc(var(--agent-meow-viewport-height, 100lvh) / 2)",
        ...
        maxHeight:
          "calc(var(--agent-meow-viewport-height, 100lvh) - var(--agent-meow-safe-top, 0px) - var(--agent-meow-safe-bottom, 0px) - 1rem)",
      }
    : {};
  return (
    <DialogPortal>
