...
// origin to the keyboard-aware `--agent-meow-viewport-height` — but only inside
...
describe("DialogContent keyboard-aware sizing", () => {
  it("caps height and centering to the visible viewport inside the iOS shell", () => {
    ...
    expect(content.style.maxHeight).toContain("--agent-meow-viewport-height");
    expect(content.style.top).toContain("--agent-meow-viewport-height");
  });
