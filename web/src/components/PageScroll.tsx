 ...
 * (`--agentmeow-header-height`, `--agentmeow-inset-top/bottom`). Off the iOS shell
...
export function PageScroll({
  ...
  const style: CSSProperties = {
    paddingTop: `calc(${extraTop}${clearHeader ? " + var(--agentmeow-header-height)" : ""}${
      insetTop ? " + var(--agentmeow-inset-top)" : ""}
    })`,
    paddingBottom: `calc(${extraBottom}${insetBottom ? " + var(--agentmeow-inset-bottom)" : ""})`,
  };
