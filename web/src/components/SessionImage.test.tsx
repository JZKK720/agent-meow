...
const getAgentMeowHostConfig = vi.fn();
const hostFetch = vi.fn();

vi.mock("@/lib/host", () => ({
  getAgentMeowHostConfig: () => getAgentMeowHostConfig(),
...
describe("SessionImage (standalone, no host fetcher)", () => {
  beforeEach(() => {
    getAgentMeowHostConfig.mockReturnValue({ fetcher: undefined });
  });
...
describe("SessionImage (embedded, host fetcher present)", () => {
  beforeEach(() => {
    getAgentMeowHostConfig.mockReturnValue({ fetcher: () => {} });
  });
