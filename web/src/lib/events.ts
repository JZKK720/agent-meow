 ...
 *
 * Emitted by the agent-meow server when the claude-native forwarder observes a
 ...
 * session.
 *
 * Emitted by the agent-meow server after a native wrapper reports an effort
 ...
 *
 * Emitted by the agent-meow server when the claude-native forwarder receives
