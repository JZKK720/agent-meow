...
export const PINNED_CONVERSATION_IDS_STORAGE_KEY = "agent-meow:pinned-conversation-ids";
...
export const COLLAPSED_SIDEBAR_SECTIONS_STORAGE_KEY = "agent-meow:collapsed-sidebar-sections";
...
export const EXPANDED_PROJECT_SECTIONS_STORAGE_KEY = "agent-meow:expanded-project-sections";
