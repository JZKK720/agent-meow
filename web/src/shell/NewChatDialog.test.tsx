...
// The paw-mic button's phase label (rule 2/4/7: ASR-off visible). The real
// hook talks to the hermesVoice singleton — mock it so each test drives
// the unified voiceState directly.
