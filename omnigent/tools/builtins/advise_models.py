"""Built-in tool: sys_advise_models â€” fan-out model sizing advisor.
...
class SysAdviseModelsTool(Tool):
                            ...
                            "items": {
                                ...
                                "properties": {
                                    ...
                                    "task": {
                                        "type": "string",
                                        "description": (
                                            "Full task description â€” the text you will "
    ...
    def invoke(self, arguments: str, ctx: ToolContext) -> str:
        """
        Unreachable â€” execution is intercepted server-side.
