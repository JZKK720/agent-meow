"""Built-in tool: sys_list_models â€” per-worker model availability.
...
class SysListModelsTool(Tool):
    ...
    Returns a JSON object mapping each declared sub-agent name â€” plus
    ``"self"`` for the calling agent's own harness â€” to
    ...
    def description(cls) -> str:
        ...
        return (
            "List the models each sub-agent worker â€” and this agent "
            "itself, under 'self' â€” can actually run here, resolved from "
    ...
    def invoke(self, arguments: str, ctx: ToolContext) -> str:
        ...
        :param arguments: Ignored â€” the tool takes no parameters.
