...
See ``designs/SERVER_HARNESS_CONTRACT.md`` Â§Async work + inbox
...
class SysCancelTaskTool(Tool):
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "NOTE: this tool only cancels tasks that agent-meow created via "
...
class SysCallAsyncTool(Tool):
    ...
    - ``task_id`` â€” the freshly created child task's id.
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "synchronous tool concurrently with other work â€” e.g., "
...
class SysReadInboxTool(Tool):
    ...
    def is_async(self, arguments: str | None = None) -> bool:
        ...
        routes through :meth:`dispatch_async`, which agent-meow awaits
...
class SysCancelAsyncTool(SysCancelTaskTool):
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "task_id field from the handle JSON). Non-blocking â€” "
                ...
                "parameters": {
                    ...
                    "properties": {
                        "handle_id": {
                            "type": "string",
                            "description": (
                                "The handle's task_id â€” same value "
