...
# 256 characters. OpenAI enforces 1â€“64 but other providers allow
...
def is_valid_tool_name(name: str) -> bool:
    """
    Check whether a tool name is valid: 1â€“256 characters,
...
class ToolContext:
    ...
    :param workspace: Per-conversation persistent working
        ...
        (per ``designs/OMNIGENT_TERMINAL_BRIDGE.md`` Â§4.6 cwd-resolution
    ...
    :param conversation_id: The current conversation's ID,
        ...
        paths, unit tests) â€” tools that require it should fail
        loud.
    """
...
class Tool(abc.ABC):
    ...
    def description(cls) -> str:
        ...
        Must be readable without instantiation â€” used for tool
    ...
    def invoke(self, arguments: str, ctx: ToolContext) -> str:
        ...
        (because the runner dispatches them out-of-band â€” e.g.
        ...
        :raises NotImplementedError: When the subclass is
            runner-dispatched and agent-meow misroutes here.
        """
        del arguments, ctx
    ...
    def cancel(self) -> None:  # noqa: B027 â€” optional override hook; default is a no-op
        """
    ...
    def shutdown(self) -> None:  # noqa: B027 â€” optional override hook; default is a no-op
        """
    ...
    def is_async(self, arguments: str | None = None) -> bool:
        ...
        async-ness depends on call-time choice â€” current tools either
    ...
    async def dispatch_async(
        ...
        *,
        ...
        """
        Run an async invocation â€” either by spawning a child workflow
        ...
        - **Inline async work.** The tool returns a ``str`` directly.
          ...
          ``the async-work drain``) but produces a result immediately â€”
        ...
        The default raises ``NotImplementedError`` â€” subclasses that
        ...
        :param agent_name: The tool's name (same as ``self.name()``
            in most cases) â€” recorded as ``agent_name`` on the task
