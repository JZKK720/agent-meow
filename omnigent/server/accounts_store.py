...
class SqlAlchemyAccountStore:
    ...
    # â”€â”€ User credentials (extends rows in the `users` table) â”€â”€â”€â”€â”€â”€
    ...
    def get_password_hash(self, user_id: str) -> str | None:
        ...
        :func:`~?omnigent.server.passwords.verify_password` â€” never
    ...
    # â”€â”€ Account tokens (invite + magic-link) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ OIDC invited emails (opt-in pre-authorization) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    #
