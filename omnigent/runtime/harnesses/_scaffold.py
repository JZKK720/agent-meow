...
# agent-meow server â†’ runner â†’ harness). Held at one day (86400s) â€” matching
...
class TurnContext:
    ...
    async def dispatch_tool(self, call_id: str, name: str, arguments: str, agent: str) -> str:
        ...
        matching ``call_id``. See Â§How agent-meow resolves action_required
    ...
    async def _guarded_run_turn(self, request: CreateResponseRequest, ctx: TurnContext) -> None:
        ...
        try:
            ...
            if idle_wd.expired():
                ...
                # the idle watchdog â€” not the connectivity error â€” is what fails
