"""Two-tier agent cache â€” disk + in-memory â€” backed by ArtifactStore."""
    ...
    def load(
        ...
        *,
        ...
        :param expand_env: Whether to expand ``${VAR}`` references in
            ...
            agents (``Agent.session_id is None`` â€” ``--agent`` /
        ...
        # Cache miss â€” download bundle, write to temp file, extract
