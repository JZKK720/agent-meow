"""Runtime caps â€” operator-configured hard ceilings."""
...
class RuntimeCaps:
    ...
    :param sandbox_enabled: Whether to use ``srt`` sandboxing for
        ...
        default. This is a runtime security policy â€” agents cannot
        ...
        binary is invoked via subprocess â€” it is validated to a
    ...
    :param default_policies: Server-wide policies appended after
        ...
        default â€” no behaviour change when the key is absent).
    :param llm: Server-level LLM configuration for policy
        ...
        ``None`` when the key is absent â€” function policies
