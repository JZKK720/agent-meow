"""
Environments primitive â€” wraps the existing inner implementation.

This module is the canonical OS-environment surface for new code
(per ``designs/SERVER_HARNESS_CONTRACT.md`` Â§Environments â€” unified
...
inner sunset gate is met (see Â§Deletions).
