...
and guaranteed to terminate â€” no sandbox escapes, no infinite
loops, no file I/O.
...
def cel_policy(
    *,
    ...
    try:
        ...
        # failures (syntax errors, undeclared references, etc.) â€” it
    ...
    def evaluate(event: PolicyEvent) -> PolicyResponse | None:
        ...
        # Eval errors (missing field, type mismatch) â†’ abstain.
