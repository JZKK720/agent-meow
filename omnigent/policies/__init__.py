"""
Policy building blocks â€” pure evaluators, no runtime state.
...
- :class:`EvaluationContext`, :class:`PolicyResult`,
  :class:`ElicitationRequest` â€” the data shapes that cross the
...
``omnigent.spec.types`` â€” those are runtime evaluation
