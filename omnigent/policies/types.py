...
# cross the harnessâ†”runner boundary) for which an unavailable policy
...
class ElicitationRequest:
    ...
    :param message: Combined human-readable reason string from all
        ASKing policies, joined with ``"; "`` per POLICIES.md Â§4.
...
class PolicyLLMClient:
    ...
    _client: Any  # omnigent.llms.client.Client â€” Any to avoid import cycle
    _model: str
