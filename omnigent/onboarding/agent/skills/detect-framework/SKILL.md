...
description: Detect Python agent frameworks from code imports and map them to agent-meow executor types. Load when the user has existing agent code to integrate.
---

# Framework Detection

When the user has existing Python code they want to integrate into
agent-meow, detect the framework from import statements and recommend
...
- Explain that agent-meow does not currently have a supported executor for that framework.
