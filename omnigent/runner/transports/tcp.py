...
and the httpx client's base URL â€” httpx handles TCP natively. This
...
def _pick_free_port() -> int:
    ...
    Standard "port allocation" trick â€” the OS guarantees the port
...
class RunnerTCPSubprocess:
    ...
    :param host: Bind host. Default ``"127.0.0.1"`` keeps the runner
        ...
        operator-deployed runners â€” externally-reachable runners
...
def create_tcp_client(
    ...
    *,
    ...
    No special transport â€” httpx handles TCP natively. The factory
