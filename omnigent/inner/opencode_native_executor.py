...
prompt and yields ``TurnComplete`` â€” the same injection/completion split as
codex-native.
"""
...
class OpenCodeNativeExecutor(NativeServerHarness):
    ...
    def _build_prompt_with_model_override(self, content: Any) -> NativePrompt | None:
        ...
        TUI-typed turns â€” the override controls the run from the start, not
...
def _content_to_native_prompt(content: Any) -> NativePrompt | None:
    ...
    :param content: Message content â€” a string or a list of content blocks
