...
A bold "ANSI-Shadow" block-letter ``agent-meow`` wordmark â€” the canonical
...
# Flat brand accent â€” kept in sync with the mascot/banner border so the
# wordmark, Otto, and the interactive REPL box all read as one color.
WORDMARK_COLOR = MASCOT_ART_COLOR

# Gradient endpoints (magenta â†’ soft pink). Used only when a caller asks
...
# Per-letter "ANSI-Shadow" glyphs â€” the canonical figlet font (as used by
...
_GLYPHS: dict[str, tuple[str, ...]] = {
    "a": (" â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— ", "â–ˆâ–ˆâ•”â•â•â•â–ˆâ–ˆâ•—", "â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘", "â–ˆâ–ˆâ•”â•â•â•â–ˆâ–ˆâ•‘", "â•šâ•â•   â•šâ•â•"),
    "g": (" â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— ", "â–ˆâ–ˆâ•”â•â•â•â•â• ", "â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ–ˆâ•—", "â•šâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•”â•", " â•šâ•â•â•â•â•â• "),
    "e": ("â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—", "â–ˆâ–ˆâ•”â•â•â•â•â•", "â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  ", "â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—", "â•šâ•â•â•â•â•â•â•"),
    "n": ("â–ˆâ–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—", "â–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ•‘", "â–ˆâ–ˆâ•”â–ˆâ–ˆâ•— â–ˆâ–ˆâ•‘", "â–ˆâ–ˆâ•‘ â•šâ–ˆâ–ˆâ–ˆâ–ˆâ•‘", "â•šâ•â•  â•šâ•â•â•â•"),
    "t": ("â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—", "â•šâ•â•â–ˆâ–ˆâ•”â•â•â•", "   â–ˆâ–ˆâ•‘   ", "   â–ˆâ–ˆâ•‘   ", "   â•šâ•â•   "),
    "-": ("        ", "        ", "â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ", "        ", "        "),
    "m": ("â–ˆâ–ˆâ–ˆâ•—   â–ˆâ–ˆâ–ˆâ•—", "â–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ•‘", "â–ˆâ–ˆâ•”â–ˆâ–ˆâ–ˆâ–ˆâ•”â–ˆâ–ˆâ•‘", "â–ˆâ–ˆâ•‘ â•šâ•â• â–ˆâ–ˆâ•‘", "â•šâ•â•     â•šâ•â•"),
    "o": (" â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— ", "â–ˆâ–ˆâ•”â•â•â•â–ˆâ–ˆâ•—", "â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘", "â•šâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•”â•", " â•šâ•â•â•â•â•â• "),
    "w": ("â–ˆâ–ˆâ•—    â–ˆâ–ˆâ•—", "â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•‘", "â–ˆâ–ˆâ•‘ â–ˆâ•— â–ˆâ–ˆâ•‘", "â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘", "â•šâ•â•â•šâ•â•â•â•šâ•â•"),
}
...
def _build_wordmark(word: str) -> tuple[str, ...]:
    ...
    :returns: The wordmark rows (top cap Â· identity Â· bottom Â· shadow).
    """
...
# five rows tall, so they pair 1:1 â€” no unpaired rows on either side.
...
def lockup_lines() -> list[str]:
    ...
    Otto sits on the left (5 rows Ã— :data:`MASCOT_ART_COL_WIDTH` cells)
...
def render_lockup(
    ...
    *,
    ...
    :param gradient: Fade the wordmark magentaâ†’pink instead of flat accent.
...
def render_compact(console: Console, *, subtitle: str | None = None) -> None:
    """
    Print the one-line brandmark: ``âœ¦ agent-meow  <subtitle>``.

    Used as a lightweight branded header on non-interactive commands that
    don't warrant the full lockup (``version``, ``status``, ``upgrade``â€¦).
    ...
    """
    line = Text(_INDENT)
    line.append("âœ¦ ", style=WORDMARK_COLOR)
