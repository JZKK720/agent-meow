...
class HostStore:
        ...
        with self._session() as session:
            ...
            if row is not None:
                if row.host_id != host_id:
                    ...
                    # with a rotated host_id â€” e.g. its local identity file
                    ...
                    # tunnel handler â€” the host then reconnect-loops forever
                    ...
                    # in this one transaction so the conversationâ†’host binding
    ...
    def register_managed_host(
        ...
        *,
        ...
        :raises ValueError: If a row for *host_id* exists under a
            DIFFERENT owner â€” a relaunch may only re-credential a host
            the same user owns.
        """
        now = now_epoch()
    ...
    def resolve_launch_token(self, token: str) -> Host | None:
        ...
        SHA-256 digest â€” the comparison happens inside an indexed
    ...
    def delete_host(self, host_id: str) -> None:
        ...
        not exist â€” deletion is invoked from best-effort cleanup paths
        that may race.
