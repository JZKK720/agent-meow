// agent-meow <-> Daytona egress relay.
//
...
// upgrades alike) to the real agent-meow server, so the in-sandbox host's
...
export default {
  async fetch(request, env) {
    ...
    // X-agent-meow-Host-Token and the WebSocket Upgrade), and body.
