"""Modal deploy glue for the agent-meow server.

Runs the standard server image (``ghcr.io/JZKK720/agent-meow-server``)
...
SERVER_IMAGE = "ghcr.io/JZKK720/agent-meow-server:latest"
