...
- Issue: [#863](https://github.com/JZKK720/agent-meow/issues/863)
- Builds on: PR [#869](https://github.com/JZKK720/agent-meow/pull/869) (community implementation of "collections")
- Status: Draft
- Author: Serena Ruan
...
- Collapsible, persisted in the existing `agent-meow:collapsed-sidebar-sections`
