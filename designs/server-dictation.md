...
point `OMNIGENT_DICTATION_MODEL_DIR` at it. Streaming dictation needs �?×
...
|---|---|---|---|
| Nemotron 0.6 B (fetch-script default) | ~9× realtime | 0.6—.7× —**too slow** | ~1.0 GB |
| `streaming-zipformer-en-2023-06-26` | —| 1.4—.3× realtime | ~190 MB |
| `streaming-zipformer-en-20M` | —| 3.6—.9× realtime | ~130 MB |
