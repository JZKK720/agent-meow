"""agent-meow UI SDK — terminal UI components for agent-meow frontends.

Built on top of :mod:`agent_meow_client`. This package provides
...
import from :mod:`agent_meow_client` directly.
