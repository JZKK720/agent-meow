...
| **RAM** | 128 GB unified LPDDR5X-8000 | 128 GB unified LPDDR5X-8000 |
...
stack** — both STT and TTS share the 8060S, which uses 128 GB unified
LPDDR5X-8000 system memory. The installer wizard auto-detects AMD / NVIDIA / Intel GPUs
