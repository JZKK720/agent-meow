...
from agent_meow_slack.auth_manager import AuthManager, pack_user_key, slack_client_id
from agent_meow_slack.events import host_id_of
from agent_meow_slack.models import UserConfig
...
from agent_meow_slack.text import truncate_option
...
class SetupFlow:
    ...
    async def _begin_setup(self, client: Any, *, team_id: str, user_id: str, view_id: str) -> None:
        ...
        try:
            ...
            # the moment the user approves — no DM, no re-running /agent_meow.
